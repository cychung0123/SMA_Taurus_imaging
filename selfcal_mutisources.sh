...
for target in $targets
do
    modellist+=$target".'""$""track'.rx345.lsb.10.sel.model,"
done
modellist=${modellist::-1}
modellist+="'"
echo $modellist
